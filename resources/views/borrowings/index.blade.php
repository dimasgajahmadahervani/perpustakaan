        ...
        <tr>
            ...
            <td>
                <form action="{{ route('borrowings.destroy',$borrowing->id) }}" method="POST">
                    ...
                    <button type="submit"  onclick = "return confirm('Anda yakin akan menghapus data Peminjaman {{ $borrowing->nama_peminjam}}? ');" class="btn btn-danger" class="btn btn-danger">Delete</button>
                </form>
            </td>
        </tr>
        @endforeach
