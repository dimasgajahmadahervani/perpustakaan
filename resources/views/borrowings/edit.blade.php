        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>NIS Peminjam</strong>
                    <select class="form-control" name="nis_peminjam">
                        @foreach($students as $student)
                    
                        <option value="{{$student->nis}}" @if($borrowing->nis_peminjam == $student->nis)selected @endif>{{$student->nis}}</option>
                        @endforeach
                    </select>  
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="radio" name="ket" value="Kembali" {{$borrowing->ket == 'Di kembalikan'? 'checked' : ''}}> Di kembalikan
